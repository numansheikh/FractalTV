...
export function EnrichmentPicker({ contentId, contentType, candidates, selectedId, onPicked, onDisabled, onReset, onRerun, onClose }: Props) {
  ...
  const handleReset = async () => {
    await api.vodEnrich.reset(contentId)
    onReset()
  }
