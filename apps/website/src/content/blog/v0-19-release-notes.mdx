...
description: One of the biggest Fractals releases so far with major Home, M3U, Xtream, Stalker, and Remote Control improvements, plus many fixes and refactorings.
featured: true
pubDate: 2026-02-19
author: FractalTV
heroImage: /fractals/blog/v0-19-xtream-category-grid.png
tags:
    - release
    - release-notes
    - v0.19
...
Fractals **v0.19** is out.

This is one of the biggest Fractals releases so far, with many fixes, refactorings, and new features. A lot of reported issues were addressed in this version.
...
- **GitHub Sponsors**: [https://github.com/sponsors/FractalTV](https://github.com/sponsors/FractalTV)
- **Buy me a coffee**: [https://ko-fi.com/FractalTV](https://ko-fi.com/FractalTV)
    ...
    links={[
        {
            ...
            href: 'https://github.com/sponsors/FractalTV',
            hint: 'Support continued development.',
            icon: 'sponsor',
        },
        {
            label: 'Ko-fi',
            href: 'https://ko-fi.com/FractalTV',
...
- Added a new landing page: [https://FractalTV.github.io/fractals/](https://FractalTV.github.io/fractals/)
- Added a new blog: [https://FractalTV.github.io/fractals/blog](https://FractalTV.github.io/fractals/blog)
    ...
    links={[
        {
            ...
            href: 'https://github.com/FractalTV/fractals/releases/tag/v0.19.0',
            hint: 'Official binaries and release assets on GitHub.',
            icon: 'download',
        },
        {
            label: 'All Releases',
            href: 'https://github.com/FractalTV/fractals/releases',
            hint: 'Browse every Fractals release on GitHub.',
            icon: 'github',
        },
    ]}
/>
