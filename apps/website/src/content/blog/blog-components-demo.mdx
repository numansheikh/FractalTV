...
description: Reusable MDX components for Fractals blog posts including alerts, CTA buttons, and terminal command blocks.
pubDate: 2026-02-15
author: FractalTV
tags:
- blog
...
<CopyCommand title="One-line fix" command="xattr -c /Applications/Fractals.app" />
...
<PostButton
  href="/fractals/blog/v0-18-release-notes/"
...
<ImageGallery
  ...
  images={[
    {
      src: '/fractals/blog/fractals-v18.jpeg',
      alt: 'Fractals v0.18 UI screenshot',
      caption: 'v0.18 interface update',
    },
    {
      src: '/fractals/blog/macos-app-damaged.jpg',
...
<BlogImageSlider
  images={[
    ...
    {
      src: '/fractals/blog/epg.png',
      alt: 'EPG guide screenshot',
      caption: 'Electronic Program Guide screen in Fractals.',
    },
  ]}
/>
